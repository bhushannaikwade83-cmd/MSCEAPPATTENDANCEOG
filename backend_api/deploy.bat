...
REM Uses your Firebase project: smartattendanceapp-bc2fe

echo 🚀 Deploying ArcFace Backend to Firebase/Cloud Run...
echo Project: smartattendanceapp-bc2fe
echo.

REM Set project (ignore environment tag warning - it's optional)
gcloud config set project smartattendanceapp-bc2fe 2>nul
